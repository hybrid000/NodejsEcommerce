    ...
    return (
        <nav id="layer1">
            <div className="part1">
                {/* Logo */}
                <Link to="/">
                    <img src="/resources/logo6.png" className="logoimg" alt="logo of site" />
                </Link>
            </div>
            <div className="part2">
            ...
            <div className="part3">
                ...
                <div className="login-signup">
                    {isAuthenticated ? (
                        ...
                        <p>
                            <i className="fa-solid fa-user fa-lg"></i>
                            <Link to="/user/login" className="ls">Login</Link> or
                            <Link to="/user/signup" className="ls">Sign Up</Link>
                        </p>
                    )}
                </div>

                {/* Wishlist, Orders, Cart */}
